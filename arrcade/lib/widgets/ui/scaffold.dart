...
class LunaScaffold extends StatelessWidget {
  ...
  /// Called when [ArrcadeDatabase.ENABLED_PROFILE] has changed. Triggered within the build function.
  ...
  Widget get android {
    return WillPopScope(
      onWillPop: () async {
        if (!ArrcadeDatabase.ANDROID_BACK_OPENS_DRAWER.read()) return true;
