...
class LunaTheme {
  ...
  static bool get isAMOLEDTheme => ArrcadeDatabase.THEME_AMOLED.read();
  static bool get useBorders => ArrcadeDatabase.THEME_AMOLED_BORDER.read();
  ...
  SystemUiOverlayStyle get overlayStyle {
    return SystemUiOverlayStyle(
      systemNavigationBarColor: ArrcadeDatabase.THEME_AMOLED.read()
          ? Colors.black
          : LunaColours.secondary,
      systemNavigationBarDividerColor: ArrcadeDatabase.THEME_AMOLED.read()
          ? Colors.black
          : LunaColours.secondary,
