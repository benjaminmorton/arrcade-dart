...
class LunaMessage extends StatelessWidget {
  ...
  factory LunaMessage.error({
    ...
    return LunaMessage(
      key: key,
      text: 'arrcade.AnErrorHasOccurred'.tr(),
      buttonText: 'arrcade.TryAgain'.tr(),
      onTap: onTap,
      useSafeArea: useSafeArea,
    );
  }
  ...
  factory LunaMessage.moduleNotEnabled({
    ...
    return LunaMessage(
      key: key,
      text: 'arrcade.ModuleIsNotEnabled'.tr(args: [module]),
      buttonText: 'arrcade.ReturnToDashboard'.tr(),
