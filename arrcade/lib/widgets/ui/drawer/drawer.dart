...
class LunaDrawer extends StatelessWidget {
  ...
  static List<LunaModule> moduleOrderedList() {
    try {
      const db = ArrcadeDatabase.DRAWER_MANUAL_ORDER;
    ...
    return ArrcadeDatabase.ENABLED_PROFILE.listenableBuilder(
      builder: (context, _) => LunaBox.indexers.listenableBuilder(
        builder: (context, _) => Drawer(
          ...
          child: ArrcadeDatabase.DRAWER_AUTOMATIC_MANAGE.listenableBuilder(
                ...
                Expanded(
                  child: LunaListView(
                    ...
                    children: _moduleList(
                      context,
                      ArrcadeDatabase.DRAWER_AUTOMATIC_MANAGE.read()
