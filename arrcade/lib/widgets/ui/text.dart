...
class LunaText extends Text {
  ...
  /// Create a [LunaText] widget with the styling pre-assigned to be a Arrcade title.
  ...
  /// Create a [LunaText] widget with the styling pre-assigned to be a Arrcade subtitle.
