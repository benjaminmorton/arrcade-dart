...
extension SonarrEpisodeExtension on SonarrEpisode {
  ...
  String lunaAirDate() {
    if (this.airDateUtc == null) return 'arrcade.UnknownDate'.tr();
  ...
  String lunaDownloadedQuality(
    ...
    if (file == null) return 'arrcade.Unknown'.tr();
    String quality = file.quality?.quality?.name ?? 'arrcade.Unknown'.tr();
