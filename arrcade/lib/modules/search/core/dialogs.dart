...
import 'package:arrcade/utils/profile_tools.dart';
...
class SearchDialogs {
  Future<Tuple2<bool, SearchDownloadType?>> downloadResult(
    ...
    await LunaDialog.dialog(
      ...
      customContent: ArrcadeDatabase.ENABLED_PROFILE.listenableBuilder(
        builder: (context, _) => LunaDialog.content(
          children: [
            Padding(
              child: LunaPopupMenuButton<String>(
                tooltip: 'arrcade.ChangeProfiles'.tr(),
                child: Container(
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          ArrcadeDatabase.ENABLED_PROFILE.read(),
                    ...
                    for (final profile in LunaBox.profiles.keys.cast<String>())
                      PopupMenuItem<String>(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: LunaUI.FONT_SIZE_H3,
                            color: ArrcadeDatabase.ENABLED_PROFILE.read() ==
                                    profile
                                ? LunaColours.accent
                                : Colors.white,
                          ),
