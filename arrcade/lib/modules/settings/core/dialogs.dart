...
import 'package:arrcade/modules/dashboard/core/adapters/calendar_starting_day.dart';
import 'package:arrcade/modules/dashboard/core/adapters/calendar_starting_size.dart';
import 'package:arrcade/modules/dashboard/core/adapters/calendar_starting_type.dart';
import 'package:arrcade/modules/settings/core/types/header.dart';
import 'package:arrcade/system/state.dart';
import 'package:arrcade/utils/validator.dart';
...
class SettingsDialogs {
  ...
  Future<Tuple2<bool, int>> changeBackgroundImageOpacity(
    ...
    final _formKey = GlobalKey<FormState>();
    final _textController = TextEditingController()
      ..text = ArrcadeDatabase.THEME_IMAGE_BACKGROUND_OPACITY.read().toString();
