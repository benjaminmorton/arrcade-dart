...
class _State extends State<ConfigurationSearchEditIndexerRoute>
  ...
  Widget _displayName() {
    ...
    return LunaBlock(
      ...
      body: [TextSpan(text: _name.isEmpty ? 'arrcade.NotSet'.tr() : _name)],
  ...
  Widget _apiURL() {
    ...
    return LunaBlock(
      ...
      body: [TextSpan(text: _host.isEmpty ? 'arrcade.NotSet'.tr() : _host)],
      trailing: const LunaIconButton.arrow(),
      onTap: () async {
        Tuple2<bool, String> values = await LunaDialogs().editText(
          context,
  ...
  Widget _apiKey() {
    ...
    return LunaBlock(
      ...
      body: [TextSpan(text: _key.isEmpty ? 'arrcade.NotSet'.tr() : _key)],
      trailing: const LunaIconButton.arrow(),
      onTap: () async {
        Tuple2<bool, String> values = await LunaDialogs().editText(
          context,
