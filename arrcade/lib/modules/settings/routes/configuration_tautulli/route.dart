    ...
    return _db.listenableBuilder(
      builder: (context, _) {
        ...
        return LunaBlock(
          ...
          body: [
            TextSpan(text: message.isEmpty ? 'arrcade.NotSet'.tr() : message),
          ],
  ...
  Widget _activityRefreshRate() {
    ...
    return _db.listenableBuilder(builder: (context, _) {
      String refreshRate = _db.read() == 1
          ? 'arrcade.EverySecond'.tr()
          : 'arrcade.EverySeconds'.tr(args: [_db.read().toString()]);
      return LunaBlock(
    ...
    return _db.listenableBuilder(
      builder: (context, _) {
        String statisticsItems = _db.read() == 1
            ? 'arrcade.OneItem'.tr()
            : 'arrcade.Items'.tr(args: [_db.read().toString()]);
        return LunaBlock(
