...
import 'package:arrcade/extensions/datetime.dart';
import 'package:arrcade/modules/dashboard/core/adapters/calendar_starting_day.dart';
import 'package:arrcade/modules/dashboard/core/api/data/abstract.dart';
import 'package:arrcade/modules/dashboard/core/api/data/lidarr.dart';
import 'package:arrcade/modules/dashboard/core/api/data/radarr.dart';
import 'package:arrcade/modules/dashboard/core/api/data/sonarr.dart';
import 'package:arrcade/modules/dashboard/core/state.dart';
import 'package:arrcade/modules/dashboard/routes/dashboard/widgets/content_block.dart';
...
class _State extends State<CalendarView> {
  ...
  Widget _calendar() {
    return LunaBox.arrcade.listenableBuilder(
      selectItems: [
