...
import 'package:arrcade/router/routes/bios.dart';
import 'package:arrcade/router/routes/dashboard.dart';
import 'package:arrcade/router/routes/external_modules.dart';
import 'package:arrcade/router/routes/lidarr.dart';
import 'package:arrcade/router/routes/nzbget.dart';
import 'package:arrcade/router/routes/radarr.dart';
import 'package:arrcade/router/routes/sabnzbd.dart';
...
import 'package:arrcade/router/routes/tautulli.dart';
import 'package:arrcade/vendor.dart';
import 'package:arrcade/widgets/pages/not_enabled.dart';
  ...
  GoRoute route({
    ...
    return GoRoute(
      ...
      builder: (context, state) {
        ...
        return NotEnabledPage(module: module?.title ?? 'Arrcade');
      },
    );
  }
