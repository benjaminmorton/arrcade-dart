...
import 'package:arrcade/api/tautulli/types.dart';
import 'package:arrcade/modules.dart';
import 'package:arrcade/modules/tautulli/core/state.dart';
import 'package:arrcade/modules/tautulli/routes/activity_details/route.dart';
import 'package:arrcade/modules/tautulli/routes/check_for_updates/route.dart';
import 'package:arrcade/modules/tautulli/routes/graphs/route.dart';
import 'package:arrcade/modules/tautulli/routes/history_details/route.dart';
import 'package:arrcade/modules/tautulli/routes/ipaddress_details/route.dart';
import 'package:arrcade/modules/tautulli/routes/libraries/route.dart';
import 'package:arrcade/modules/tautulli/routes/libraries_details/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_logins/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_newsletters/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_notifications/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_plex_media_scanner/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_plex_media_server/route.dart';
import 'package:arrcade/modules/tautulli/routes/logs_tautulli/route.dart';
import 'package:arrcade/modules/tautulli/routes/media_details/route.dart';
import 'package:arrcade/modules/tautulli/routes/recently_added/route.dart';
import 'package:arrcade/modules/tautulli/routes/search/route.dart';
import 'package:arrcade/modules/tautulli/routes/statistics/route.dart';
import 'package:arrcade/modules/tautulli/routes/synced_items/route.dart';
import 'package:arrcade/modules/tautulli/routes/tautulli/route.dart';
import 'package:arrcade/modules/tautulli/routes/users_details/route.dart';
