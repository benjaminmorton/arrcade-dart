...
import 'package:arrcade/api/radarr/models/movie/movie.dart';
import 'package:arrcade/modules.dart';
import 'package:arrcade/modules/radarr/core/state.dart';
import 'package:arrcade/modules/radarr/routes/add_movie/route.dart';
import 'package:arrcade/modules/radarr/routes/add_movie_details/route.dart';
import 'package:arrcade/modules/radarr/routes/edit_movie/route.dart';
import 'package:arrcade/modules/radarr/routes/history/route.dart';
import 'package:arrcade/modules/radarr/routes/manual_import/route.dart';
import 'package:arrcade/modules/radarr/routes/manual_import_details/route.dart';
import 'package:arrcade/modules/radarr/routes/movie_details/route.dart';
import 'package:arrcade/modules/radarr/routes/queue/route.dart';
import 'package:arrcade/modules/radarr/routes/radarr/route.dart';
import 'package:arrcade/modules/radarr/routes/releases/route.dart';
import 'package:arrcade/modules/radarr/routes/system_status/route.dart';
import 'package:arrcade/modules/radarr/routes/tags/route.dart';
