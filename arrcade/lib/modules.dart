...
extension LunaModuleMetadataExtension on LunaModule {
  String get title {
    switch (this) {
      ...
      case LunaModule.WAKE_ON_LAN:
        return 'Wake on LAN';
      case LunaModule.EXTERNAL_MODULES:
        return 'arrcade.ExternalModules'.tr();
    }
  }
  ...
  String? get information {
    switch (this) {
      ...
      case LunaModule.SEARCH:
        return 'Arrcade currently supports all indexers that support the newznab protocol, including NZBHydra2.';
      case LunaModule.SETTINGS:
        return null;
      case LunaModule.SONARR:
      ...
      case LunaModule.EXTERNAL_MODULES:
        return 'Arrcade allows you to add links to additional modules that are not currently supported allowing you to open the module\'s web GUI without having to leave Arrcade!';
    }
  }
}
...
extension LunaModuleWebhookExtension on LunaModule {
  ...
  String? get webhookDocs {
    switch (this) {
      case LunaModule.LIDARR:
        return 'https://docs.arrcade.app/arrcade/notifications/lidarr';
      case LunaModule.RADARR:
        return 'https://docs.arrcade.app/arrcade/notifications/radarr';
      case LunaModule.SONARR:
        return 'https://docs.arrcade.app/arrcade/notifications/sonarr';
      case LunaModule.OVERSEERR:
        return 'https://docs.arrcade.app/arrcade/notifications/overseerr';
      case LunaModule.TAUTULLI:
        return 'https://docs.arrcade.app/arrcade/notifications/tautulli';
      default:
        return null;
    }
  }
...
extension LunaModuleExtension on LunaModule {
  ...
  Widget informationBanner() {
    String key = 'ARRCADE_MODULE_INFORMATION_${this.key}';
