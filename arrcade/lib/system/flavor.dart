...
import 'package:arrcade/system/environment.dart';
...
extension LunaFlavorExtension on LunaFlavor {
  ...
  String get downloadLink {
    String base = 'https://builds.arrcade.app/#latest';
    switch (this) {
      case LunaFlavor.EDGE:
  ...
  String get name {
    switch (this) {
      case LunaFlavor.EDGE:
        return 'arrcade.Edge'.tr();
      case LunaFlavor.BETA:
        return 'arrcade.Beta'.tr();
      case LunaFlavor.STABLE:
        return 'arrcade.Stable'.tr();
    }
  }
