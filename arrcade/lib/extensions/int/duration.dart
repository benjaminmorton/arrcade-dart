...
extension IntegerAsDurationExtension on int? {
  ...
  String asWordDuration({
    ...
    if (this == null || this! <= 0) return 'arrcade.Unknown'.tr();
    ...
    if (hours > 1) {
      return 'arrcade.Hours'.tr(args: [hours.toString()]);
    }

    final minutes = seconds ~/ _MINUTE_IN_SECONDS;
    if (minutes > 0) {
      return 'arrcade.Minutes'.tr(args: [minutes.toString()]);
    }

    return 'arrcade.Seconds'.tr(args: [seconds.toString()]);
  }
