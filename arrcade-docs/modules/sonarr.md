...
Adding your Sonarr instance to Arrcade only requires a few steps to get going!

{% hint style="warning" %}
This documentation only covers adding Sonarr to Arrcade via local network (LAN) connections, and does not cover exposing Sonarr externally and connecting remotely.
{% endhint %}
...
In Sonarr's web GUI, go to Settings -> General and check the value of "URL Base". If you have nothing set, you can move on. If you do have a value set, please remember the set value as it will be necessary when setting the host within Arrcade.

## Connecting in Arrcade
