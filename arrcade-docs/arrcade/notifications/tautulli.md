...
In Tautulli's web GUI, head to Settings -> Notification Agents, hit the "Add a new notification agent" button and select "Arrcade". Please follow each section below to setup the webhook:
...
Enter in the name of the profile which should be an **exact match** to the profile that this module instance was added to within Arrcade. Capitalization and punctuation _does_ matter.
...
Once setup, close Arrcade and run the webhook test in Tautulli. You should receive a new notification letting you know that Arrcade is ready to receive Tautulli notifications!
