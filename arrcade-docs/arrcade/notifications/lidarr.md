...
{% tabs %}
{% tab title="Name" %}
Select any name, for example "Arrcade".
{% endtab %}
...
{% tab title="Username" %}
The username field should be an **exact match** to the profile that this module instance was added to within Arrcade. Capitalization and punctuation _does_ matter.
...
Once setup, close Arrcade and run the webhook test in Lidarr. You should receive a new notification letting you know that Arrcade is ready to receive Lidarr notifications!
