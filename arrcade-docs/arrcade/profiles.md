...
Do you have multiple instances of modules you want to add to Arrcade? Profiles are the way to do this! Arrcade allows you to have an infinite amount of profiles, each of which can contain a whole new set of configurations for modules.
...
There are multiple ways to switch profiles within Arrcade.
