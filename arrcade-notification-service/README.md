...
A TypeScript backend service that handles receiving webhooks from applications supported in [Arrcade](https://www.arrcade.app/github) and sends notifications to the respective user or device.

> Setting up an instance of your own notification service is **not** necessary to get webhook notifications in Arrcade, simply use the hosted notification service available at [https://notify.arrcade.app](https://notify.arrcade.app). Setting up your own instance _will not_ send notifications to the officially published Arrcade application.
>
> Setting up your own instance of the notification service is only necessary when building your own version of Arrcade, which utilizes a different Firebase project.

## Usage

For documentation on setting up the webhooks, please look at Arrcade's documentation [available here](https://notify.arrcade.app).
...
ghcr.io/jagandeepbrar/arrcade-notification-service:latest
```

## Development & Installation

Arrcade's Notification Service requires:
